...
var app = angular.module('starter', ['ionic', 'app.bookingCtrl', 'autocomplete.directive', 'app.mainCtrl', 'app.flightsSrv' , 'app.paymentCtrl', 'app.outgoingFlights', 'app.returnFlights', 'app.namesCtrl', 'app.confirmation']);
